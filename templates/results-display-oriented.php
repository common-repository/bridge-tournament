...
<h1 class="bt-title-centered"> <?php _e('North-South', 'bt') ?> </h1>
...
<div class="tournaments_results">
	<table class="wp-t-table widefat fixed posts" cellspacing="0">
		...
		<tbody>
<?php		foreach ( $trn_data_NS as $pair ): ?>
			<tr>
				<td><?php echo $pair['pair_id'] ?></td>
				<td><?php echo $pair['orientation'] ?></td>
...
<br>
<h1 class="bt-title-centered"> <?php _e('East-West', 'bt') ?> </h1>
...
<div class="tournaments_results">
	<table class="wp-t-table widefat fixed posts" cellspacing="0">
		...
		<tbody>
<?php		foreach ( $trn_data_EW as $pair ): ?>
			<tr>
				<td><?php echo $pair['pair_id'] ?></td>
				<td><?php echo $pair['orientation'] ?></td>
				<td><?php echo $pair['player1'] ?></td>
