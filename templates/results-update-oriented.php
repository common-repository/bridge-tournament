<?php
/**
 * Display tournament result for update with orientation (Mitchell tournaments)
 *
 * @license GPLv3
 * @version 0.1	
...
<?php		foreach ( $trn_data as $pair ): ?>
			<tr>
				...
				<td><input type="text" name="pair_orientation[<?php echo $ind; ?>]" size="2" value ="<?php echo $pair['orientation']?>"/></td>				                
